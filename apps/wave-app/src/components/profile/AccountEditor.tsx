...
import { ApiError, changePassword, updateDisplayName } from "../../auth/api";
...
/**
 * Edição da própria conta — nome e senha.
 *
 * **Existia como leitura** porque, no porte, as rotas ainda não estavam de pé;
 * elas existem desde a P12 (`PATCH /auth/me`, `POST /auth/password`) e o perfil
 * seguia mostrando campos mortos. A troca de **e-mail** é outro fluxo, de dois
 * passos, e vem em fatia própria.
 *
  ...
  return (
    <>
      <Panel title="Dados da conta" eyebrow="identificação">
        ...
        {/* O e-mail continua em leitura: trocá-lo é um fluxo de dois passos,
            com código no endereço novo, e ganha tela própria. */}
