...
/**
 * Iniciais de uma pessoa num disco.
 *
 * É **ornamento**: o nome inteiro aparece sempre em texto ao lado, então o
 * disco fica fora do leitor de tela — anunciar "AM" logo antes de "Ana
 * Martins" só atrapalha quem navega ouvindo. Fica com `aria-hidden`, que é o
 * atributo que vale nas duas pontas sem vazar prop desconhecida para o DOM.
 *
 * Foto de perfil é backlog; até lá, iniciais.
 */
...
export function Avatar({ name, size = 44, tone }: Props) {
  const t = useTheme();
