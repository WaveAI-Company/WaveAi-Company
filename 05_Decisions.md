...
5. **Domínio próprio, com DNS na Cloudflare.** Decidido pelo fundador em 2026-08-23: o custo é baixo e um endereço `*.a.run.app` numa ficha de loja não passa credibilidade. Isso também deixa a porta aberta para túnel ou proxy no futuro sem trocar de fornecedor de DNS.
